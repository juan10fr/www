    ...
    <?php
        ...
        while ($registro = mysqli_fetch_row($resultado)){
            ...
            echo '<form name="ficha" action="modificaevento.php" method="POST">';	
                ...
                echo "<tr><td class='text-right text-warning'>ID_EVENTO: </td><td><h5>",$registro[0],"</h5><input class='form-control' type='hidden' name='id' value='$registro[0]'></td></tr>";
                ...
                echo "<tr><td class='text-right text-warning'>FECHA DE INICIO: </td><td><input class='form-control' type='text' name='clave' size='20' value='$registro[2]'></td></tr>";
                echo "<tr><td class='text-right text-warning'>FECHA DE FIN: </td><td><input class='form-control' type='text' name='nombape' size='40' value='$registro[3]'></td></tr>";
                echo "<tr><td class='text-right text-warning'>DIRECCION: </td><td><input class='form-control' type='text' name='nivel' size='40' value='$registro[4]'></td></tr>";
        ...
        <div class="row py-1 bg-dark text-info">
            ...
            <div class="col-3 text-center"> 
                <a href="gestionevento.php" method="post">
                    <p class="close">Cancelar
                    <input type="image" SRC="estilos/BTNCANCERLAR.png" name="cancelar" height="30" ALT="cancelar">
                    </p> 
                </form>
            </div> 
