...
?>
    ...
    <?php
        ...
        while ($registro = mysqli_fetch_row($resultado)){
            ...
            echo '<form name="ficha" action="modificacliente.php" method="POST">';	
                ...
                echo "<tr><td class='text-right text-warning'>DIRECCION: </td><td><input class='form-control' type='text' name='nombape' size='40' value='$registro[3]'></td></tr>";
                echo "<tr><td class='text-right text-warning'>TELEFONO: </td><td><input class='form-control' type='text' name='nivel' size='40' value='$registro[4]'></td></tr>";
                echo "<tr><td class='text-right text-warning'>EMAIL: </td><td><input class='form-control' type='text' name='niveles' size='40' value='$registro[5]'></td></tr>";
        ...
        <div class="row py-1 bg-dark text-info">
            ...
            <div class="col-3 text-center"> 
                <a href="gestioncliente.php" method="post">
