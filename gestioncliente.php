		...
		<div class="row text-center">	
            ...
            while ($registro = mysqli_fetch_row($resultado)){
				...
				echo "<td align='center'>";
					...
					// Formulario para enviar los datos
						echo '<form name="veruno" method="POST" action="vercliente.php">';
						echo '<input type="hidden" name="codigo" value="'.$registro[0].'">';
				...
				echo "</td><td align='center'>";		
					...
					// Formulario para enviar los datos
						echo '<form name="BorrarUno" method="POST" action="BorrarDos.php">';
						echo '<input type="hidden" name="codigo" value="'.$registro[0].'">';
				...
				echo "</td><td align='center'>";		
					...
					// Formulario para enviar los datos
						echo '<form name="modificar-evento" method="POST" action="modificar-cliente.php">';
						echo '<input type="hidden" name="codigo" value="'.$registro[0].'">';
